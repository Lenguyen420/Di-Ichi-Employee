        ...
        <div className="relative border-b border-orange-100 bg-gradient-to-br from-orange-50 via-white to-amber-50 px-5 py-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-orange-600">Employee Portal</p>
            </div>
          </div>
          {/* <div className="mt-5 rounded-2xl border border-orange-100 bg-white/80 p-3">
            ...
            <p className="mt-1 text-sm font-black text-slate-900">Sẵn sàng cho module mới</p>
            <div className="mt-3 h-2 rounded-full bg-orange-100">
              <div className="h-2 w-[36%] rounded-full bg-gradient-to-r from-orange-500 to-amber-400" />
            </div>
          </div> */}
        </div>
          ...
          {/* <div className="rounded-2xl bg-slate-50 p-3">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-black text-slate-900">Hỗ trợ nhân viên</p>
                <p className="truncate text-xs text-slate-500">Employee Office</p>
              </div>
            </div>
          </div> */}
          <button
